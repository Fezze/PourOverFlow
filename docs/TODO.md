...
- Expand the new `npm run preview:watch` visual baseline beyond the initial round `480x480` screenshots if later review passes need square layouts, richer icon rendering, or more than one state per screen.
